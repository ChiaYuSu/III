...
for i in range(len(caseList.Fake_case_20200928)):
    ssl._create_default_https_context = ssl._create_unverified_context
    src = "https://raw.githubusercontent.com/ChiaYuSu/III/master/20200928/" + caseList.Fake_case_20200928[i] + "/output.json"
    ...
    count_third = 0
    count_forth = 0
    timestamp = caseList.Fake_case_timestamp2[i]
    ...
    # print
    print("---------------------------------------------------------------------")
    print("Case:", caseList.Fake_case_20200928[i])
